...
namespace Chatly.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var result = await dataservice.LoginAsync(model.Email, model.Password);
            if (result != null)
            {
                Session["user"] = result;
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var result = await dataservice.CreateAsync(new Users() { Email = model.Email, UserName = model.UserName }, model.Password);
                if (result != null)
                {
